...
async def main():
    ...
    job_queue = JobQueue() # JobQueue 인스턴스 생성
    application.job_queue = job_queue # application에 JobQueue 할당
    job_queue.set_dispatcher(application.dispatcher)  # Dispatcher 연결
